...
const Navbar = () => {
    ...
    return (
        ...
        >
            <Box>
                <Text id='logo'><Link activeClass="active" to="home" spy={true} smooth={true}  duration={700} cursor={'pointer'}>Chandrakanth</Link></Text>
            </Box>
            <Box  display={["none", "none",'none',"flex"]} id='navMenu'>
                ...
                {/* <Text display={'flex'} bg={'linear-gradient(43deg, #4158D0 0%, #C850C0 46%, #FFCC70 100%)'} color={'white'} borderRadius={'2%'} p={1} position={'relative'} bottom={1} alignItems={'center'}><a download="Chandrakanth-Resume" href={resume}>Resume</a><HiDownload/></Text> */}
            </Box>
            ...
            <DrawerHeader borderBottomWidth='1px' position={'absolute'} right={"0"} onClick={onClose} ><CloseIcon/></DrawerHeader>
                <DrawerBody fontWeight={700} fontSize='xl'>
                    ...
                    {/* <Text mt={8}  display={'flex'} bg={'linear-gradient(43deg, #4158D0 0%, #C850C0 46%, #FFCC70 100%)'} color={'white'} borderRadius={'2%'} p={1} position={'relative'} bottom={1} alignItems={'center'}><a download="Chandrakanth-Resume" href={resume} >Resume</a><HiDownload/></Text> */}
                </DrawerBody>
            </DrawerContent>
            </Drawer>
            </Box>
